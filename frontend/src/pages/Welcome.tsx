...
const Welcome = () => {
  ...
  return (
    <div className="md:flex md:flex-row md:h-screen md:w-full  flex flex-col h-screen gap-10 ">
      <div className="md:w-1/3 md:flex md:flex-col md:h-full md:justify-start items-center p-3 justify-center md:border md:border-r-2 h-1/5 ">
      ...
      <div className=" h-4/5 p-10 md:w-2/3  ">
        <p className="text-[#2a4b60] text-xl p-2 mb-5" >Please answer the following questions:</p>
        <div className=" p-3 rounded-xl shadow-2xl md:shadow-none ">
          ...
          {currentQuestionIndex < 8 ? (
            <button onClick={handleNextQuestion} className="relative inline-flex items-center justify-start py-3 pl-4 ml-52 md:ml-96 mt-5 pr-12 overflow-hidden font-semibold text-[#4D89AD] transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
